...
The header is defined by the area before the line that says `//:---[END-HEADER]---`.
Optionally, you can also start the header with `//:--[BEGIN-HEADER]---` and the content before the
header will be preserved.
